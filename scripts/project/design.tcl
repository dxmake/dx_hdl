...
## Add an instance of an module to the block design.
#
# \param[i_module] - name of the module
# \param[i_name] - name of the instance
# \param[i_params] - a list of the parameters, the list must contain {name, value}
# pairs
#
proc ad_module_instance {i_module i_name {i_params {}}} {

  set cell [create_bd_cell -type module -reference ${i_module} ${i_name}]
  if {$i_params != {}} {
    set config {}
    # Add CONFIG. prefix to all config options
    foreach {k v} $i_params {
